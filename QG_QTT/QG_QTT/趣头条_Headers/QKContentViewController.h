...
@class IMYWebView, IncomeNoticeView, JavaScriptOC, LCFloatView, NJKWebViewProgressView, NSDate, NSString, QKChannel, QKContentModel, QKContentToolBar, QKReadAntiCheatingManager, QKReadAntiCheatingModel, QKReadAntiCheatingView, QKRedView, articlePieChartView, floatingView, read_conf_Model;
