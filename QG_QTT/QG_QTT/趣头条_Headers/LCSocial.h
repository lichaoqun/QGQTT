...
@interface LCSocial : NSObject <LCShareActionSheetDelegate>
{
    ...
    NSString *_chosenShareType;
}

+ (id)sharedInstance;
@property(copy, nonatomic) NSString *chosenShareType; // @synthesize chosenShareType=_chosenShareType;
...
- (void).cxx_destruct;
- (void)reportWithShareType:(int)arg1 shareUrl:(id)arg2 isSystem:(_Bool)arg3 resultCode:(int)arg4 resultMsg:(id)arg5;
...
- (void)updateShortVersion:(id)arg1 shareContentiOSWay:(id)arg2 shareTypes:(id)arg3 appID:(id)arg4 CDNServices:(id)arg5;
- (void)shareActionSheetDismiss;
- (void)requestArticleShareInfoWithParam:(id)arg1 handler:(CDUnknownBlockType)arg2;
...
- (void)share_content:(id)arg1 src:(long long)arg2 shareBlock:(CDUnknownBlockType)arg3 bottomBlock:(CDUnknownBlockType)arg4 actionTypeBlock:(CDUnknownBlockType)arg5 resultBlock:(CDUnknownBlockType)arg6;
- (_Bool)handleParams:(id)arg1 content:(id)arg2;
- (void)inviteShareMod:(id)arg1 targetIsShare:(id)arg2 target:(id)arg3;
- (void)inviteShareMod:(id)arg1 inviteFrom:(id)arg2 object:(id)arg3;
