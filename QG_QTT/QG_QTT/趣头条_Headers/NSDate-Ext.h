...
+ (long long)dateTimeDifferenceWithTime:(id)arg1;
+ (_Bool)judgeTimeIsTimePeriodByStartAndEnd:(_Bool)arg1 startTime:(id)arg2 endTime:(id)arg3;
+ (id)getNewDateWithDate:(id)arg1 Moth:(long long)arg2 day:(long long)arg3 hour:(long long)arg4 second:(long long)arg5;
