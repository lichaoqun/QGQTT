...
@interface ColdAppConfig : LCBaseModel
{
    ...
    NSDictionary *_lvJRShowFloat;
}

@property(nonatomic) int redType; // @synthesize redType=_redType;
@property(nonatomic) _Bool redEnable; // @synthesize redEnable=_redEnable;
@property(retain, nonatomic) NSDictionary *lvJRShowFloat; // @synthesize lvJRShowFloat=_lvJRShowFloat;
